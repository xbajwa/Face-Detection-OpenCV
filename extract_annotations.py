...
for i in range(0,315):
    df = pd.read_csv(f'C:/Users/opera_user/Documents/folder/{i}.txt', delimiter=' ', header=None,error_bad_lines=False) # reading object annotation files given in VIRAT Dataset
